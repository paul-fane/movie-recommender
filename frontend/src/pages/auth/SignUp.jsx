...
export default function SignUp(props) {
  ...
  const validateInputs = () => {
    ...
    if (!re_password.value || re_password.value.length < 1) {
      setRePasswordError(true);
      setRePasswordErrorMessage("Password must be at least 1 characters long.");
      isValid = false;
    } else {
          ...
          >
            ...
            <FormControl>
              ...
              <TextField
                ...
                helperText={re_passwordErrorMessage}
                color={re_passwordError ? "error" : "primary"}
              />
            </FormControl>
            <Button
              type="submit"
